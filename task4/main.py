...
def plot_examples(X_examples, Y_examples, ):
    ...
    axs[0, 0].imshow(X_examples[0], cmap='viridis')
    axs[0, 0].set_title(names[Y_examples[0]])

    axs[0, 1].imshow(X_examples[1], cmap='viridis')
    axs[0, 1].set_title(names[Y_examples[1]])

    axs[1, 0].imshow(X_examples[2], cmap='viridis')
    axs[1, 0].set_title(names[Y_examples[2]])

    axs[1, 1].imshow(X_examples[3], cmap='viridis')
    axs[1, 1].set_title(names[Y_examples[3]])
